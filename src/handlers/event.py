    ...
    if request.method == "GET":
        if isLoggedIn():
            return render_template("events_list.html",
                                   ...
                                   .filter_by(event_host_id=getCurrentUser().id)  # noqa E501
...
def event():
    ...
    readEvent = db.query(Event).filter_by(id=event_id) \
                               .filter_by(event_host_id=user.id).first()
    if request.method == "POST":
        if event_id is None and action == "create":
            event_host_id = user.id
            event_name = request.form.get('event_name')
            event_invitation_text = request.form.get('event_invitation_text')
            ...
            event_recurrence_period = request.form.get('event_recurrence_period')  # noqa E501
            send_event_invite_before_days = request.form.get('send_event_invite_before_days')  # noqa E501
            send_event_invite_at_hour = request.form.get('send_event_invite_at_hour')  # noqa E501
            event_remind_before_hours = request.form.get('event_remind_before_hours')  # noqa E501
            ...
            if readEvent.event_host_id == getCurrentUser().id:
                event_id = event_id
                event_host_id = getCurrentUser().id
                event_name = request.form.get('event_name')
                event_invitation_text = request.form.get('event_invitation_text')  # noqa E501
                event_start_date = request.form.get('event_start_date')
                event_end_date = request.form.get('event_end_date')
                event_time_start = request.form.get('event_time_start')
                event_duration_minutes = request.form.get('event_duration_minutes')  # noqa E501
                event_recurrence_period = request.form.get('event_recurrence_period')  # noqa E501
                send_event_invite_before_days = request.form.get('send_event_invite_before_days')  # noqa E501
                send_event_invite_at_hour = request.form.get('send_event_invite_at_hour')  # noqa E501
                event_remind_before_hours = request.form.get('event_remind_before_hours')  # noqa E501
                ...
                Event.update(
                            ...
                            event_recurrence_period=event_recurrence_period,
                            send_event_invite_before_days=send_event_invite_before_days,  # noqa E501
                            send_event_invite_at_hour=send_event_invite_at_hour,  # noqa E501
                            event_remind_before_hours=event_remind_before_hours,  # noqa E501
                            invitation_list_id=invitation_list_id)
                notification_msg = "You have updated Event successfully!"
                print(notification_msg)

                return redirectToRoute("event_handlers.events_list") \
                    if isLoggedIn() else redirectToLogin()
            else:
                notification_msg = "You don't have permissions to change Event!"  # noqa E501
                print(notification_msg)
            ...
            if readEvent.event_host_id == user.id:
                ...
                notification_msg = "You don't have permissions to delete Event!"  # noqa E501
                print(notification_msg)
            return redirectToRoute("event_handlers.events_list") \
                if isLoggedIn() else redirectToLogin()
        else:
